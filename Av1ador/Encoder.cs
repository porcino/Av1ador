    ...
    internal class Encoder : ICloneable
    {
        ...
        public void Vf_add(string f, [Optional] string v, [Optional] string a, [Optional] string b, [Optional] string c)
        {
            ...
            else if (f == "Vulkan")
            {
                ...
                Vf.Add("\"" + Bit_Format(10) + ",hwupload,libplacebo=minimum_peak=2:percentile=99.6:gamut_mode=relative:tonemapping=bt.2446a:range=tv:color_primaries=bt709:color_trc=bt709:colorspace=bt709:" + Bit_Format() + ",hwdownload," + Bit_Format() + "\"");
            }
            else if (f == "anime4k")
